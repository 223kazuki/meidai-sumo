  ...
  {:app/club {:abouts
              [{:about/id "declation"
               ...
               {:about/id "keiko"
                ...
                :about/content [:div
                                [:h2 "日程"]
                                "火・木曜日　１７：００～２０：００" [:br]
                                "土曜日　９：００～１２：００"
                                [:h2 "場所"]
                                "名古屋大学相撲部道場（東山キャンパス）"
                                [:h2 "内容"]
                                "稽古は週３で行っています。" [:br]
                                "稽古日は火曜日（１７時から）、木曜日（１７時から）、土曜日（９時から）です。" [:br]
                                "土曜日の稽古は毎週１２時頃からみんなでチャンコを作って食べています。" [:br]
                                "土曜日は稽古見学会もありますので、気軽に足を運んで下さい。もちろん平日でも結構です。" [:br]
                                "道場はバス・トイレ・キッチン完備です。"]}
               {:about/id "chanko"
                :about/title "ちゃんこ"
                :about/content [:div
               ...
               {:about/id "schedule"
                ...
                :about/content [:div
                                [:table
                                 [:tbody
                                  [:tr [:th "1月"]  [:td "稽古始め"]]
                                  [:tr [:th "2月"]  [:td "紋別合宿（北海道紋別市）" [:br] "オフ"]]
                                  [:tr [:th "3月"]  [:td "追旅行（様々な名所へ遠出。）"]]
                                  [:tr [:th "4月"]  [:td "入学祭典（一風変わった出し物で勝負します。）" [:br] "花見" [:br] "春季学内相撲大会"]]
                                  [:tr [:th "5月"]  [:td "BBQ" [:br] "東海近畿リーグ相撲大会（滋賀県立武道館）" [:br] "全国国公立大会"]]
                                  [:tr [:th "6月"]  [:td "名大祭に参加" [:br] "西日本インカレ（大阪府堺市大浜公園）"]]
                                  [:tr [:th "7月"]  [:td "西日本体重別選手権（大阪府堺市大浜公園）" [:br] "香港上海倶楽部大会（東京都江戸川区総合レクリエーション公園相撲場）"]]
                                  [:tr [:th "8月"]  [:td "答志島合宿（三重県鳥羽市答志島）" [:br] "全国七大学総合体育大会（東北大学）"]]
                                  [:tr [:th "9月"]  [:td "静内合宿（北海道静内郡静内町）" [:br] "全国体重別選手権（大阪府堺市大浜公園 / 靖国神社相撲場）"]]
                                  [:tr [:th "10月"] [:td "大須素人相撲大会（大須観音）" [:br] "名古屋大学防衛大学校対抗戦（名古屋大学 / 防衛大学校）"]]
                                  [:tr [:th "11月"] [:td "全国インカレ（両国国技館 / 大阪府堺市大浜公園）" [:br] "秋季学内相撲大会"]]
                                  [:tr [:th "12月"] [:td "稽古納め" [:br] "納旅行（年納めを楽しい旅行で）"]]]]]}
   ...
   :app/record {:records
                [{:record/year "2011"
                  :record/content [:div
                                   [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　準優勝　金城　長合　壹岐　野澤　岩田"]
                                   [:p "新人戦　第３位　野澤大輔"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体戦　　　　　準優勝　壹岐　長合　小島　野澤　岩田"]
                                   [:p "個人戦　　　　　優勝　岩田将誉"]
                                   [:p "６５キロ未満級　準優勝　小島徹也"]
                                   [:p "７５キロ級　　　第３位　壹岐英明"]
                                   [:p "７５キロ超級　　優勝　岩田将誉"]
                                   [:h2 "名古屋大学・防衛大学校定期対抗戦"]
                                   [:p "団体戦"]
                                   [:p "　準優勝　金城　長合　壹岐　野澤　岩田"]
                                   [:p "個人戦　優勝　　岩田将誉"]
                                   [:p "　　　　準優勝　野澤大輔"]]}
                 {:record/year "2010"
                  :record/content [:div
                                   [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　第３位　金城　岩田　壹岐　長合　河合"]
                                   [:p "個人戦　優勝　　岩田将誉"]
                                   [:p "　　　　第３位　河合賢吾"]
                                   [:p "新人戦　第３位　壹岐英明"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体準　　　　　優勝　金城　岩田　小島　長合　河合"]
                                   [:p "６５キロ未満級　優勝　小島徹也"]]}
                 {:record/year "2009"
                  :record/content [:div
                                   [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　優勝　　堤、近藤、岩田、河合、清水"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体戦　　　　　優勝　　野原、岩田、河合、小島、近藤"]
                                   [:p "個人戦　　　　　優勝　　近藤弘章"]
                                   [:p "６５キロ未満級　優勝　　堤一樹"]
                                   [:p "６５キロ未満級　準優勝　野原裕史"]
                                   [:p "６５キロ未満級　第３位　小島徹也"]
                                   [:p "無差別級　　　　第３位　近藤弘章"]
                                   [:h2 "名古屋大学・防衛大学校定期対抗戦"]
                                   [:p "団体戦　準優勝　　名大A　野原、岩田、堤、河合、近藤"]
                                   [:p "団体戦　第三位　　名大B"]
                                   [:h2 "全国学生相撲選手権大会"]
                                   [:p "Cクラス　団体戦　準優勝　野原、岩田、堤、河合、近藤"]]}
                 {:record/year "2008"
                  :record/content [:div
                                   [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　準優勝　　市橋、菊地、近藤、河合、本間"]
                                   [:h2 "西日本学生相撲選手権大会"]
                                   [:p "二部　団体戦　第三位　　市橋、菊地、山口、河合、本間"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体戦　準優勝　　市橋、菊地、近藤、河合、本間"]
                                   [:p "新人戦　第三位　　野原裕史"]
                                   [:h2 "名古屋大学・防衛大学校定期対抗戦"]
                                   [:p "団体戦　優勝　　　名大A　市橋、菊地、山口、河合、本間"]
                                   [:p "団体戦　第三位　　名大B"]
                                   [:p "個人戦　第三位　　本間裕幸"]
                                   [:p "個人戦　第三位　　菊地良貴"]
                                   [:p "新人戦　準優勝　　野原裕史"]
                                   [:p "新人戦　第三位　　岩田将誉"]]}
                 {:record/year "2007"
                  :record/content [:div [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　第四位　　古木、菊地、本間、近藤、長野"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体戦　　優勝　　　古木、菊地、近藤、長野、本間"]
                                   [:p "個人戦　　準優勝　　古木治郎"]
                                   [:p "無差別級　第三位　　山口顕"]
                                   [:h2 "名古屋大学・防衛大学校定期対抗戦"]
                                   [:p "団体戦　準優勝　　名大A　山口、本間、菊地、近藤、古木"]
                                   [:p "団体戦　第三位　　名大C"]
                                   [:p "個人戦　準優勝　　古木治郎"]
                                   [:h2 "全国学生相撲選手権大会"]
                                   [:p "Bクラス　団体戦　ベスト１６　　山口、菊地、近藤、古木、長野"]
                                   [:p "Cクラス　団体戦　第三位　　　　山口、菊地、近藤、古木、長野"]]}
                 {:record/year "2006"
                  :record/content [:div
                                   [:h2 "全国国公立大学対抗相撲大会"]
                                   [:p "団体戦　優勝　　　岸根、福井、新美、古木、田中　"]
                                   [:p "個人戦　第三位　　大崎貴弘"]
                                   [:h2 "全国七大学総合体育大会"]
                                   [:p "団体戦　　　　　優勝　　　新美、古木、鈴木、樋掛、福井"]
                                   [:p "個人戦　　　　　優勝　　　福井高信"]
                                   [:p "個人戦　　　　　準優勝　　新美将平"]
                                   [:p "７５キロ未満級　優勝　　　福井高信"]
                                   [:p "７５キロ未満級　準優勝　　古木治郎"]
                                   [:h2 "西日本学生相撲個人体重別選手権大会"]
                                   [:p "７５キロ未満級　準優勝　　鈴木博之"]
                                   [:p "７５キロ未満級　第三位　　福井高信"]
                                   [:h2 "名古屋大学・防衛大学校定期対抗戦"]
                                   [:p "団体戦　準優勝　名大A"]
